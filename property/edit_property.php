...
<head>
    ...
    <script>
        function validateForm() {
            let propertyName = document.getElementById('property_name').value;
            let propertyType = document.getElementById('property_type').value;
            let price = document.getElementById('price').value;
            let location = document.getElementById('location').value;
            let description = document.getElementById('description').value;

            if (!propertyName || !propertyType || !price || !location || !description) {
                alert('Please fill in all fields.');
                return false; // Prevent form submission
            }

            // Optional: Add a confirmation dialog
            return confirm("Are you sure you want to update this property?");
        }
    </script>
</head>
<body>
    ...
    <div class="container">
        ...
        <nav>
            <ul>
                ...
                <li><a href="all_properties.php">View Properties</a></li>
...
<form action="edit_property.php?id=<?php echo $id; ?>" method="POST" onsubmit="return validateForm()">
    <label for="property_name">Property Name:</label>
    <input type="text" name="property_name" id="property_name" value="<?php echo $row['property_name']; ?>" required><br>

    <label for="property_type">Property Type:</label>
    <input type="text" name="property_type" id="property_type" value="<?php echo $row['property_type']; ?>" required><br>
